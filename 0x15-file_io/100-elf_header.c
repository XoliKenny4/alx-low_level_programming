...
/**
 * check_elf - Examines if a file is an ELF file
 ...
 * @e_ident: Pointer to an array containing magic ELF numbers.
 *
 * Description: Magic ELF numbers are seperated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: Pointer of an array containing the ELF class
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * Return: On success 0
 *
 * Description: If file isn't an ELF file or
 * the function fails - exit code 98
 */
int main(int __attribute__ argc, char *argv[])
{
	Elf64_Ehdr *header;
	int o, r;
